@extends('layouts/detachedLayoutMaster')
    @section('title', 'Contact')
        ...
        .carta .social-link2:hover {
        background-color: #00ccff;
        animation: bounce_613 0.4s linear;
        }

        .carta .social-link3:hover {
        background-color: #5865f2;
        animation: bounce_613 0.4s linear;
        }

        .carta .social-link4:hover {
        background-color: #12a50b;
        animation: bounce_613 0.4s linear;
        }
    ...
    $(document).ready(function () {
      toastr['success']('👋  We appreciate your feedback and will review it shortly.', 'Comment Sent', {
      closeButton: true,
      tapToDismiss: false,
      progressBar: true,
...
@endif
        <div class="mx-3 card p-1 ">
            <div class="d-flex justify-content-center">
                <img src="{{asset('images/logo/logoC.png')}}">
            </div>
            <div class="d-flex justify-content-center">
                <hr width="70%" size="5x">
            </div>
            <div class="row">
                <div class="col-lg-6 pt-2 col-xs-12 col-md-12 col-sm-12">
                    <div class="">
                        <div class="cart">
                ...
                <div class="col-lg-6 col-xs-12 col-md-12 col-sm-12">
                  <form action="{{route('Comment.store')}}" method="POST">
                    ...
                    <div class="col-12 mb-1 mb-sm-0 pb-3 pt-2">
                        <div class="form-floating">
                          <input type="text" class="form-control" id="floating-label1" name="name" placeholder="Your name " width="100px"/>
                          <label for="floating-label1">Your name</label>
                          @if ($errors->has('name'))
                          <span class="text-danger">{{ $errors->first('name') }}</span>
                        @endif
                        </div>
                    </div>
                    <div class="col-12  mb-1 mb-sm-0 pb-3">
                        <div class="form-floating">
                          <input type="text" class="form-control" id="floating-label1" name="email" placeholder="Your Email" width="100px" />
                          <label for="floating-label1">Your Email</label>
                          @if ($errors->has('email'))
